 ...
 * Otherwise, it closely resembles postEventAndSuspend(); please see the documentation
 ...
 *
 * @note
 * I'd have preferred to overload the name postEventAndSuspend() for both signatures.
 * But consider the following ambiguous call:
 * @code
 * postEventAndSuspend(LLSD(), requestPump, replyPump, "someString");
 * @endcode
