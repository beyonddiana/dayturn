...
void register_viewer_callbacks(LLMessageSystem* msg)
{
	...
	msg->setHandlerFuncFast(_PREHASH_ObjectProperties,			process_object_properties, NULL); //GN This is a hack to make FS area search work see llviewermessage for implementation
