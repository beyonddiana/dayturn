...
//#pragma endregion Setup various values from Settings
            ...
            //PhysicsShapePrimTriangles - Physics shape for this prim is triangular mesh (typically when prim is cut/hollow etc)
    {
        ...
        gGL.diffuseColor4fv(color.mV);        // TODO: (BEQ) We ought to be able to use a common draw call here too?
        glPolygonOffset(offset_factor, offset_units);
...
void LLViewerWindow::renderSelections( BOOL for_gl_pick, BOOL pick_parcel_walls, BOOL for_hud )
{
	...
	{		
        ...
        //GN to be refactored if we also take the ShowSpecificLODInEdit additions from FS. See commits before merge on 27 sept 2018 by Beq
