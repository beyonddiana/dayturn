...
class LLAdvancedToggleRenderType : public view_listener_t
{
	bool handleEvent(const LLSD& userdata)
	{
		...
		if ( render_type != 0 )
		{
			...
			LLPipeline::toggleRenderTypeControl( (ptrdiff_t)render_type );
#else
...
class LLAdvancedCheckRenderType : public view_listener_t
{
	bool handleEvent(const LLSD& userdata)
	{
		...
		{
#if (LL_LINUX) && defined(__amd64__)
			new_value = LLPipeline::hasRenderTypeControl( ptrdiff_t)render_type );
#else
...
class LLAdvancedToggleFeature : public view_listener_t
{
	bool handleEvent(const LLSD& userdata)
	{
		...
		{
#if (LL_LINUX) && defined(__amd64__)
			LLPipeline::toggleRenderDebugFeature( (ptrdiff_t)feature );
#else
	...
	bool handleEvent(const LLSD& userdata)
{
	...
	{
#if (LL_LINUX) && defined(__amd64__)
		new_value = LLPipeline::toggleRenderDebugFeatureControl( (ptrdiff_t)feature );
#else
...
class LLAdvancedToggleInfoDisplay : public view_listener_t
{
	bool handleEvent(const LLSD& userdata)
	{
		...
		{
#if (LL_LINUX) && defined(__amd64__)
			LLPipeline::toggleRenderDebug( (ptrdiff_t)info_display );
#else
...
class LLAdvancedCheckInfoDisplay : public view_listener_t
{
	bool handleEvent(const LLSD& userdata)
	{
		...
		{
#if (LL_LINUX) && defined(__amd64__)
			new_value = LLPipeline::toggleRenderDebugControl( (ptrdiff_t)info_display );
#else
