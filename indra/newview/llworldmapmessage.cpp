...
{
	//LL_INFOS("WorldMap") << "LLWorldMap::sendNamedRegionRequest()" << LL_ENDL;
	LLMessageSystem* msg = gMessageSystem;
...
void LLWorldMapMessage::sendHandleRegionRequest(U64 region_handle, 
		...
		bool teleport)	// immediately teleport when result returned
{
	//LL_INFOS("WorldMap") << "LLWorldMap::sendHandleRegionRequest()" << LL_ENDL;
...
{
	//LL_INFOS("WorldMap") << "LLWorldMap::sendMapBlockRequest()" << ", min = (" << min_x << ", " << min_y << "), max = (" << max_x << ", " << max_y << "), nonexistent = " << return_nonexistent << LL_ENDL;
	LLMessageSystem* msg = gMessageSystem;
...
void LLWorldMapMessage::processMapBlockReply(LLMessageSystem* msg, void**)
{
	...
	//LL_INFOS("WorldMap") << "LLWorldMap::processMapBlockReply(), num_blocks = " << num_blocks << LL_ENDL;
...
{
	//LL_INFOS("WorldMap") << "LLWorldMap::processMapItemReply()" << LL_ENDL;
	U32 type;
